...
- [Launch Action Control](../../assemble/launch-asset-packager/references/action-control.md) — receipt-bound snapshots, required-action joins, and close-window semantics
