...
**Primary next skill**: [content-quality-auditor](../../../tune/content-quality-auditor/SKILL.md) — gate a representative page sample for thin/duplicate risk before mass publish. This mode does **not** compute the CORE-EEAT score or run the veto items; it hands the sample forward.
